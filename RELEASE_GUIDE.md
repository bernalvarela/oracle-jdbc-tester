...
```xml
<version>1.7.0</version>  <!-- Change this -->
```
...
2. Fill in the form:
   - **Choose a tag:** Select `v1.7.0` (the tag you just pushed)
   - **Release title:** `Release 1.7.0`
...
- Ensure the tag is pushed: `git push origin v1.7.0`
